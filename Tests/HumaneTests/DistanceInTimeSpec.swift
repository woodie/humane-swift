        ...
        describe("Humane.distanceInTime with no options (the recommended defaults: approximate true, includeSeconds false)") {
            ...
            context("just now") {
                it("displays less than a minute ago") {
                    expect(Humane.distanceInTime(base, base)).to(equal("less than a minute ago"))
                }
            }
            ...
            context("45 seconds ago") {
                it("rounds up to 1 minute ago (past the 30-second cutoff)") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("1 minute ago"))
                }
            }
            ...
            context("3 minutes ago") {
                it("displays 3 minutes ago") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("3 minutes ago"))
                }
            }
            ...
            context("1 hour ago") {
                it("displays about 1 hour ago") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("about 1 hour ago"))
                }
            }
            ...
            context("15 hours ago") {
                it("displays about 15 hours ago") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("about 15 hours ago"))
                }
            }
            ...
            context("30 hours ago") {
                it("rolls up to 1 day ago, with no about (ActionView's table has none on the day bucket)") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("1 day ago"))
                }
            }
            ...
            context("3 days ago") {
                it("displays 3 days ago") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("3 days ago"))
                }
            }
            ...
            context("45 seconds from now") {
                it("rounds up to in 1 minute (past the 30-second cutoff)") {
                    let when = base.addingTimeInterval(45)
                    expect(Humane.distanceInTime(when, base)).to(equal("in 1 minute"))
                }
            }
            ...
            context("3 minutes from now") {
                it("displays in 3 minutes") {
                    let when = base.addingTimeInterval(180)
                    expect(Humane.distanceInTime(when, base)).to(equal("in 3 minutes"))
                }
            }
            ...
            context("3 hours from now") {
                it("displays in about 3 hours") {
                    ...
                    expect(Humane.distanceInTime(when, base)).to(equal("in about 3 hours"))
                }
            }
        }
        ...
        describe("Humane.distanceInTime with includeSeconds: true") {
            ...
            context("just now") {
                it("displays 0 seconds ago") {
                    expect(Humane.distanceInTime(base, base, includeSeconds: true)).to(equal("0 seconds ago"))
                }
            }
            ...
            context("1 second ago") {
                it("displays 1 second ago, singular") {
                    ...
                    expect(Humane.distanceInTime(when, base, includeSeconds: true)).to(equal("1 second ago"))
                }
            }
            ...
            context("45 seconds ago") {
                it("displays 45 seconds ago") {
                    let when = base.addingTimeInterval(-45)
                    expect(Humane.distanceInTime(when, base, includeSeconds: true)).to(equal("45 seconds ago"))
                }
            }
            ...
            context("45 seconds from now") {
                it("displays in 45 seconds") {
                    let when = base.addingTimeInterval(45)
                    expect(Humane.distanceInTime(when, base, includeSeconds: true)).to(equal("in 45 seconds"))
                }
            }
        }
        ...
        describe("Humane.distanceInTime with approximate: false") {
            ...
            context("1 hour ago") {
                it("displays the exact count, no about prefix") {
                    let when = base.addingTimeInterval(-3600)
                    expect(Humane.distanceInTime(when, base, approximate: false)).to(equal("1 hour ago"))
                }
            }
            ...
            context("15 hours ago") {
                it("displays 15 hours ago") {
                    let when = base.addingTimeInterval(-15 * 3600)
                    expect(Humane.distanceInTime(when, base, approximate: false)).to(equal("15 hours ago"))
                }
            }
        }
